...
(function() {
  ...
  (function($, window) {
    var Asides, Sidenote, SidenoteGroup, escapeExpression, log;
    $.fn.extend({
      asides: function() {
        var args, option;
        ...
        return this.each(function() {
          ...
          $this = $(this);
          plugin = (_ref = $this.data('asides')) != null ? _ref : $this.data('asides', new Asides(this, option));
          if (typeof option === 'string') {
            plugin[option].apply(plugin, args);
            if (option === 'destroy') {
              $this.removeData('asides');
            }
          }
          return true;
        });
    ...
    Asides = (function() {
      ...
      function Asides(postContainerEl, options) {
        ...
        $footnotes = $(this.options.footnoteContainerSelector + ' ' + this.options.footnoteSelector, this.$postContainer);
      ...
      Asides.prototype.show = function(force) {
      ...
      Asides.prototype.hide = function(force) {
        var group, sidenote, _i, _j, _len, _len1, _ref, _ref1;
        if (!this.isHidden || force) {
          _ref = this.sidenotes;
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      Asides.prototype.sidenotePlacement = function(placement, force) {
        var group, sidenote, _i, _j, _len, _len1, _ref, _ref1;
      ...
      Asides.prototype.destroy = function() {
    ...
    Sidenote = (function() {
      function Sidenote(footnoteEl, ref, owner) {
        ...
        this.$pivot = this.refMark().parentsUntil(this.owner.$postContainer).last();
        this.group = null;
